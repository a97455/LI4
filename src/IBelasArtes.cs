...
public interface IBelasArtes {
	...
	bool RegistarLeilao(ref int codPintura, ref Date dataInicio, ref Date dataFim, ref float precoInicial);
	bool RegistarPintura(ref string nome, ref float altura, ref float largura, ref float peso, ref string descricao,
	    ref string: artista, ref bool autenticidade, ref Year anoCriacao, ref int codMovimentoArtistico);
