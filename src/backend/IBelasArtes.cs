...
namespace BelasArtes{
	...
	List<Leilao.Leilao> FiltrarArtista(ref string artista);
	List<Leilao.Leilao> GetHistoricoCompras(ref string email);
	List<Leilao.Leilao> GetHistoricoVendas(ref string email);
	...
	List<Leilao.Leilao> OrdenarLeiloesDecorrer(ref int codModoOrdenacao);
